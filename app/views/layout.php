...
<head>
    ...
    <title><?= htmlspecialchars($exportData['title'] ?? '') ?></title>
    <meta name="keywords" content="<?= htmlspecialchars($exportData['keywords'] ?? '') ?>" />
    <meta name="description" content="<?= htmlspecialchars($exportData['description'] ?? '') ?>" />
    ...
    <link rel="icon" type="image/png" sizes="120x120" href="/android-chrome-192x192.png">

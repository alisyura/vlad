...
class Config
{
    private static $config = [
        ...
        'global' => [
            'SITE_NAME' => 'Смехбук – анекдоты юмор сатира и шутки на любой вкус',
            'SITE_KEYWORDS' => 'смехбук, анекдоты, свежие анекдоты, смешные, истории, фразы, карикатуры, карикатура, стишки, стешок, мемы, сатира',
            'SITE_DESCRIPTION' => 'Смехбук - самые смешные анекдоты, истории, фразы и афоризмы, сатира, стишки, карикатуры и другой юмор. Ежедневно добавляем свежие анекдоты. Выходят с 11 ноября 2025 года.',
